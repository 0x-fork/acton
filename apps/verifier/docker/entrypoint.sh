...
write_generated_config() {
...

    {
        ...
        write_optional_int max_json_file_bytes "${VERIFIER_UPLOAD_MAX_JSON_FILE_BYTES:-1048576}"
        write_optional_int max_tolk_file_bytes "${VERIFIER_UPLOAD_MAX_TOLK_FILE_BYTES:-524288}"
        write_optional_int max_func_file_bytes "${VERIFIER_UPLOAD_MAX_FUNC_FILE_BYTES:-524288}"
        write_optional_int max_tact_file_bytes "${VERIFIER_UPLOAD_MAX_TACT_FILE_BYTES:-524288}"
    } > "$config_path"
}
