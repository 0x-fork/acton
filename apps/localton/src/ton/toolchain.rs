...
impl Toolchain {
    ...
    /// Resolves a state-specific Fift script and falls back to the pinned release.
    ///
    /// Generated network scripts belong to the state directory, while standard
    /// wallet scripts remain owned by the shared TON distribution.
