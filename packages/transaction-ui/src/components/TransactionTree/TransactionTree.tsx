...
function SystemSourceTooltipContent(): React.JSX.Element {
  return (
    <div className={`${styles.tooltipContent} ${styles.systemTooltip}`}>
      <div className={styles.tooltipField}>
        <div className={styles.tooltipFieldLabel}>System</div>
        <div className={`${styles.tooltipFieldValue} ${styles.tooltipDescription}`}>
          This internal message was generated by the blockchain protocol, not sent by a smart
          contract.
        </div>
      </div>
    </div>
...
export function TransactionTree({
  ...
  const renderCustomNodeElement = ({nodeDatum}: CustomNodeElementProps): React.JSX.Element => {
    ...
    if (
      ...
      const sourceLabel = isSystemSource ? "System" : nodeDatum.name
        ...
        <g
          ...
          onMouseEnter={event => {
            ...
            showTooltip({
              x: rect.left,
              y: rect.top,
              content: <SystemSourceTooltipContent />,
            })
          }}
          onMouseLeave={() => {
